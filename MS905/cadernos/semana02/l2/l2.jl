...
md"""
ℓ = $(@bind l_box Slider(1:30, show_value=true, default=1))
"""
...
# ╔═╡ a5f71837-a94d-4778-9f35-28bb499d84aa
typeof(apolo_head)
...
function gaussian_kernel_1D(n; σ=1)
	vect=[gauss(i,σ) for i=-n:n]
	soma=sum(i for i=vect)
...
function with_gaussian_blur(image; σ=3, l=5)
	vect=[gauss(x,y,σ=σ) for x=-l:l, y=-l:l]
	soma=sum(i for i=vect)
	vect=vect./soma
	
    return convolve(image, vect)
end
